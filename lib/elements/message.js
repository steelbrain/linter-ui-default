...
import { getMessageClass, getMessageRange, visitMessage, htmlToText } from '../helpers'
...
export default class Message extends React.Component {
  ...
  render() {
    const { message, includeLink, includeProvider, includeCopyLink } = this.props
    return (<linter-message>
      { includeCopyLink && Message.getCopyLink(message) }
