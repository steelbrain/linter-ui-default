...
export class PanelElement {
  constructor() {
    ...
    this.panel.refs.toggleContent.addEventListener('click', () => {
      this.toggleContent()
    })
    this.panel.refs.destroy.addEventListener('click', () => {
      this.destroy()
    })
  }
  toggleContent() {
    const content = this.panel.refs.content
    const button = this.panel.refs.toggleContent
  ...
  get content() {
    return this.panel.refs.content
  }
  set count(count) {
    this.panel.status.count = count
  }
