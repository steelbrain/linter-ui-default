    ...
    <div class="inset-panel">
      <div class="panel-heading">
        ...
        <div class="heading-status">
          <linter-bottom-status $setCount={setCount} class="status-success">
            <span class="icon icon-check"></span> No Issues
          </linter-bottom-status>
        </div>
        <div class="heading-icons">
          <span title="Minimize/Maximize" onclick={toggleContent}>{icons.MIN}</span>
          <span title="Hide" class="panel-button-hide">✖</span>
        </div>
      </div>
