...
export function getMessagesOnPoint(messages: Set<Message | LegacyMessage>, filePath: string, cursorPosition: Point): Set<Message> {
...
export function sortMessages(messages: Array<Message | LegacyMessage>): Array<Message> {
