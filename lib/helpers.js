...
export function getMessagesOnPoint(messages: Set<Message>, filePath: string, cursorPosition: Point): Set<Message> {
...
export function sortMessages(messages: Array<Message>): Array<Message> {
