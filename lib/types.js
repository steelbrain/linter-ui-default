...
export type TreeViewHighlights = Map<string, { highlights: Set<string>, projectPath: string }>
export type TreeViewPatch = {
  added: TreeViewHighlights,
  removed: TreeViewHighlights,
}
