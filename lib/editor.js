...
import type { Disposable, TextEditor, TextBuffer, TextEditorGutter, TextEditorMarker, Point } from 'atom'
...
export default class Editor {
  ...
  constructor(textEditor: TextEditor, buffer: Buffer, visibility: boolean) {
    ...
    this.subscriptions.add(textEditor.onDidChangeCursorPosition(({newBufferPosition}) => {
      this.debouncedUpdateBubble(newBufferPosition)
    }))
    this.debouncedUpdateBubble = debounce(this.updateBubble, 35)
  }
