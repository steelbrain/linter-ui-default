...
import type { Disposable, TextEditor, BufferMarker, TextEditorGutter, TextEditorMarker, Point } from 'atom'
...
export default class Editor {
  ...
  constructor(textEditor: TextEditor, visibility: boolean) {
    this.bubble = null
    ...
    const tooltipFollows = atom.config.get('linter-ui-default.tooltipFollows')
