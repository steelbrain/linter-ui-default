...
class Commands {
  ...
  applyAllSolutions() {
    ...
    const messages = helpers_1.sortMessages(helpers_1.filterMessages(this.messages, textEditor.getPath()), ['line', 'desc']);
  ...
  move(forward, globally, severity = null) {
    ...
    const messages = helpers_1.sortMessages(helpers_1.filterMessages(this.messages, globally ? null : currentFile, severity), ['file', 'asc']);
    ...
    for (let i = 0, length = messages.length; i < length; i++) {
      ...
      if (messageFile && messageRange) {
        ...
        if (messageFile === currentFile && currentPosition.compare(messageRange.start) === expectedValue) {
          found = message;
          break;
        }
      }
...
exports.default = Commands;module.exports = exports.default;