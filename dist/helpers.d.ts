...
export declare function getActiveTextEditor(): TextEditor | null | undefined;
...
export declare function filterMessagesByRangeOrPoint(messages: Set<LinterMessage> | Array<LinterMessage> | Map<string, LinterMessage>, filePath: string, rangeOrPoint: Point | RangeCompatible): Array<LinterMessage>;
...
export declare function sortMessages(sortInfo: Array<{
    column: string;
    type: 'asc' | 'desc';
}>, rows: Array<LinterMessage>): Array<LinterMessage>;
export declare function sortSolutions(solutions: Message['solutions']): MessageSolution[];
