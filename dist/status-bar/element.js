...
class Element {
  constructor() {
    ...
    this.subscriptions.add(this.emitter, atom.tooltips.add(this.itemErrors, { title: 'Linter Errors' }), atom.tooltips.add(this.itemWarnings, { title: 'Linter Warnings' }), atom.tooltips.add(this.itemInfos, { title: 'Linter Infos' }));
...
exports.default = Element;module.exports = exports.default;