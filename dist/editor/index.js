...
class Editor {
    ...
    listenForCurrentLine() {
        this.subscriptions.add(this.textEditor.observeCursors(cursor => {
            ...
            subscriptions.add(new atom_1.Disposable(function () {
                if (this.currentLineMarker) {
                    this.currentLineMarker.destroy();
                    this.currentLineMarker = null;
                }
    ...
    listenForMouseMovement() {
        ...
        return disposable_event_1.default(editorElement, 'mousemove', lodash_1.debounce(event => {
    ...
    listenForKeyboardMovement() {
        return this.textEditor.onDidChangeCursorPosition(lodash_1.debounce(({ newBufferPosition }) => {
