"use strict";var _$template = require("solid-js/web").template;var _web = require("solid-js/web");const _tmpl$ = _$template(`<div class="linter-messages"></div>`, 2);
  ...
  constructor(messages, position, textEditor) {
    ...
    messages.forEach(message => {
      if (message.version === 2) {
        children.push((0, _web.createComponent)(message_1.default, { get key() {return message.key;}, delegate: delegate, message: message }));
      }
    });
    web_1.render(() => (() => {const _el$ = _tmpl$.cloneNode(true);(0, _web.insert)(_el$, children);return _el$;})(), this.element);
    setTimeout(() => {
...
exports.default = TooltipElement;module.exports = exports.default;